            ...
            <div className='w-full h-full flex 800px:flex-row flex-col items-center justify-center 800px:justify-start 800px:pr-[30px]'>
                ...
                >
                    <div className='w-full max-w-[1200px] relative'>
                        ...
                        <div className=' relative z-20 w-full 800px:text-[18px] text-[14px] flex flex-col gap-4 text-justify 1500px:px-[120px] 1000px:px-[80px] px-[50px] 800px:py-[30px] py-[20px] text-[#2B3235] font-bold'>
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
